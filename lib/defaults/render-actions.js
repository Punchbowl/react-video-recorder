...
var Actions = /*#__PURE__*/function (_PureComponent) {
  ...
  function Actions() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTick", function (state) {
  ...
  _createClass(Actions, [{
    ...
    value: function renderContent() {
      ...
      if (!isInlineRecordingSupported && !isVideoInputSupported || thereWasAnError || isConnecting) {
        return null;
      }
      ...
      var maxSeconds = Math.floor(timeLimit / 1000);
      var maxReadySeconds = Math.floor(countdownTime / 1000);
